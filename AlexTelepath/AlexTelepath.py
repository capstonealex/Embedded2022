...
import canopen
import network.CircularBuffer as CircularBuffer
# from numpy import loadtxt
from machineLearning.MLAlex import MLAlex
from interface.AlexStates import AlexState
...
#variables
    ...
    def start(self):
        ...
        # while self.Jetson.numPdo==0:
        #     pass
        # startTime = time.perf_counter()
        

        # while self.Jetson.numPdo < 349:
        #     pass
        # endTime = time.perf_counter() - startTime

        # print("Time to receive:", endTime)
