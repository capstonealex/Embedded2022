...
from ..interface.AlexStates import AlexState, Intent
...
class MLAlex(object):
    def __init__(self):
        ...
        self.crutch_intent = {"walkFR~fwd" : Intent.NORMALWALK,"walkFR~back":Intent.BKSTEP,  "walkFR~stand": Intent.FTTG, 
        "walkFL~fwd":Intent.NORMALWALK,"walkFL~stand": Intent.FTTG, "stand~back": Intent.BKSTEP, "stand~fwd": Intent.NORMALWALK, "stand~sit": Intent.SITDOWN }
